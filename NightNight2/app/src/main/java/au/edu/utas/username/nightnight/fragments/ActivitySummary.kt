 ...
 * Use the [ActivitySummary.newInstance] factory method to
 * create an instance of this fragment.
 */
class ActivitySummary : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ActivitySummary.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ActivitySummary().apply {
